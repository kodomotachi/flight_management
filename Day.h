...
struct Date {
	...
	char minute[3];
	Date() {
		strcpy_s(this->day, "00");
		strcpy_s(this->month, "00");
		strcpy_s(this->year, "0000");
		strcpy_s(this->hour, "00");
		strcpy_s(this->minute, "00");
	}
	Date(const Date& date) {
		sprintf_s(this->day, "%s", date.day);
		sprintf_s(this->month, "%s", date.month);
		sprintf_s(this->year, "%s", date.year);
		sprintf_s(this->hour, "%s", date.hour);
		sprintf_s(this->minute, "%s", date.minute);
	}
};
